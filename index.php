		...
		<div id="slider-main">
			<div class="banner-text-agile text-center">
				<div class="container">
					...
					<p class="text-light"> We bake the best breads, pastries, jams and cakes, doughnuts and ice cream
						...
						<div class="w3l-specilamk">
							<div class="row">
								<div class="col-lg-6 product-name-w3l">
									...
									<a href="#order" class="button-3 active mt-5 py-4 scroll orderNowButton" data-category="' . strtolower($product->category) . '" data-product="' . strtolower($product->name) . '">Order Now</a>
								</div>
						...
						<form action="cart.php" method="post">
							<div class=" form-group">
								...
								<select required onchange="productChanged(this)">
									...
									<?php
									$result = mysqli_query($conn, "SELECT DISTINCT category FROM product");
									if (mysqli_num_rows($result) > 0) {
										while ($row = mysqli_fetch_assoc($result)) {
											$cat = $row["category"];
							...
							<div id="levelsWrap" class=" form-group d-none">
								...
								<input style="border: 1px solid;" placeholder="1*" type="number" name="" id="" min="1" max="5">
								<div class="clear"></div>
							</div>
							<div class="quantityWrap form-group">
								<label>Quantity</label>
								<input style="border: 1px solid;" placeholder="1*" type="number" name="" id="" min="1" max="9" required>
								<div class="clear"></div>
							</div>
					...
					<div class="faq-w3agile mt-5" id="faqs">
						...
						<ul class="faq list-unstyled">
							...
							<li class="item3 my-3">
								...
								<ul class="list-unstyled">
									<li class="subitem1">
										<p class="pt-3 pb-4">JazzCash only</p>
									</li>
								</ul>
							</li>
