		...
		$contactForm.submit(e => {
			...
			$.ajax({
				...
				success: data => {
					...
					$modal.find(".modal-body>p").text("Your response has been recorded. We will contact you as soon as possible!");
					$contactForm[0].reset();
				},
				error: data => {
					$modal.find(".modal-title").text("Error");
					$modal.find(".modal-body>p").html("Form submission failed!<br>Error: "+data.responseText);
