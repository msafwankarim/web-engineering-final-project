					...
					<div class="service-in text-left">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<p class="card-text">We offer a full menu of artisanal, handcrafted food that is made
					...
					<div class="service-in text-left mt-5">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<p class="card-text">We are obsessed with making the best cakes and pastries to satisfy

									our customers' sweet tooth desires.
	...
	<div class="some-another text-center pb-5">
		...
		<div class="container pb-xl-5 pb-lg-3">
			...
			<h4 class="aboutright about-right-2">At E-Bakers we are proud to be a small batch specialty bakery
				...
				specializing in handcrafted pastries, artisan cakes, and artisan pastries from the finest bakeries and

				food producers throughout <strong>Islamabad</strong> .</h4>

			<h5 class="text-uppsecase font-weight-bold text-dark mt-4">Nadeem Altaf
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row support-bottom text-center">
				...
				<div class="container">
					...
					<div class="row mt-30" style="justify-content: center;">

						<div class="col-md-3 col-6">

							<div class="box15">

								<img src="images/bilal.jpg" alt="" class="img-fluid">

								<div class="box-content">

									<h3 class="title">Bilal Malik</h3>
                                                                        <span class="reg">3873-FBAS/BSSE/F18</span>
						...
						<div class="col-md-3 col-6">
							...
							<div class="box15">
								...
								<img src="images/huzaifa.jpg" alt="" class="img-fluid">

								<div class="box-content">

									<h3 class="title">Huzaifa Ahsan</h3>
									<span class="reg">3797-FBAS/BSSE/F18</span>
						...
						<div class="col-md-3 col-6">
							...
							<div class="box15">
								...
								<img src="images/safwan.jpg" alt="" class="img-fluid">
                                                                

								<div class="box-content">

									<h3 class="title">Safwan Karim</h3>
                                                                        <span class="reg">3848-FBAS/BSSE/F18</span>
